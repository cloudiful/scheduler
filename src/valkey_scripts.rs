...
pub(crate) mod guard {
    ...
    pub(crate) const ACQUIRE_RESOURCE: &str =
        include_str!("lua/valkey_guard/acquire_resource.lua");
    pub(crate) const RENEW_OCCURRENCE: &str =
        include_str!("lua/valkey_guard/renew_occurrence.lua");
    ...
    pub(crate) const RELEASE_RESOURCE: &str =
        include_str!("lua/valkey_guard/release_resource.lua");
}

pub(crate) mod coordinated {
    pub(crate) const SAVE_STATE: &str =
        include_str!("lua/valkey_coordinated_store/save_state.lua");
